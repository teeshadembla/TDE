...
const NewsHeaderDemo = () => {
  return(
    <>
      <section id='hero-news' className="relative z-0 flex flex-col justify-center items-center h-[420px] mb-[40px] bg-black [background-image:radial-gradient(circle_closest-corner_at_50%_0,_#004aad,_#000)] "> 
